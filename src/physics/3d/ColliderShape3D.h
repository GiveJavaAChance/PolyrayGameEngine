...
namespace ColliderShape3D {
    ...
    inline bool collideAABB_AABB_3D(Collider3D& a, AABB* aData, Collider3D& b, AABB* bData, CollisionInfo3D& out) {
    ...
    inline bool collideSphere_Sphere_3D(Collider3D& a, Sphere* aData, Collider3D& b, Sphere* bData, CollisionInfo3D& out) {
        double halfAx = a.sizeX * 0.5;
        double halfAy = a.sizeY * 0.5;
        double halfAz = a.sizeZ * 0.5;
        double halfBx = b.sizeX * 0.5;
    ...
    inline bool collideSphere_AABB_3D(Collider3D& a, Sphere* aData, Collider3D& b, AABB* bData, CollisionInfo3D& out) {
        double halfAx = a.sizeX * 0.5;
        double halfAy = a.sizeY * 0.5;
        double halfAz = a.sizeZ * 0.5;
        double halfBx = b.sizeX * 0.5;
    ...
    inline bool collideBean_Bean_3D(Collider3D& a, Bean* aData, Collider3D& b, Bean* bData, CollisionInfo3D& out) {
    ...
    inline bool collideBean_AABB_3D(Collider3D& a, Bean* aData, Collider3D& b, AABB* bData, CollisionInfo3D& out) {
    ...
    inline bool collideBean_Sphere_3D(Collider3D& a, Bean* aData, Collider3D& b, Sphere* bData, CollisionInfo3D& out) {
        dvec3 lineA = prvl::dvec3(a.posX, a.posY, a.posZ) + aData->deltaA;
        dvec3 lineD = aData->deltaB - aData->deltaA;
    ...
    inline static void registerBuiltinColliders(Physics3D* physicsSystem) {
        physicsSystem->registerCollision<AABB,   AABB,   collideAABB_AABB_3D>();
        physicsSystem->registerCollision<Sphere, Sphere, collideSphere_Sphere_3D>();
        physicsSystem->registerCollision<Sphere, AABB,   collideSphere_AABB_3D>();
        physicsSystem->registerCollision<Bean,   Bean,   collideBean_Bean_3D>();
        physicsSystem->registerCollision<Bean,   AABB,   collideBean_AABB_3D>();
        physicsSystem->registerCollision<Bean,   Sphere, collideBean_Sphere_3D>();
    }
}
