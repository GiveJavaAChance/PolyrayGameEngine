...
public class Rotator {
    ...
    private final Vector3f a = new Vector3f(1.0f, 0.0f, 0.0f);
    private final Vector3f b = new Vector3f(0.0f, 1.0f, 0.0f);
    private final Vector3f c = new Vector3f(0.0f, 0.0f, 1.0f);
    ...
    private Vector3f rotate(Vector3f k, Vector3f v, float ang) {
        ...
        float sinHalfAngle = (float) Math.sin(ang * 0.5);
        float cosHalfAngle = (float) Math.cos(ang * 0.5);
